        ...
        if include_optional:
            return StatusModule(
                ...
                primary_completion_date_struct = clinicaltrials.models.partial_date_struct.PartialDateStruct(
                    date = '', 
                    type = 'ACTUAL', ),
                completion_date_struct = clinicaltrials.models.partial_date_struct.PartialDateStruct(
                    date = '', 
                    type = 'ACTUAL', ),
                ...
                disp_first_post_date_struct = clinicaltrials.models.date_struct.DateStruct(
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    type = 'ACTUAL', ),
                last_update_submit_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                last_update_post_date_struct = clinicaltrials.models.date_struct.DateStruct(
                    date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(), 
                    type = 'ACTUAL', )
            )
        else:
